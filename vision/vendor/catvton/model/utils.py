...
def init_diffusion_model(diffusion_model_name_or_path, unet_class=None):
    ...
    text_encoder = CLIPTextModel.from_pretrained(diffusion_model_name_or_path, subfolder="text_encoder", local_files_only=True)
    vae = AutoencoderKL.from_pretrained(diffusion_model_name_or_path, subfolder="vae", local_files_only=True)
    tokenizer = CLIPTokenizer.from_pretrained(diffusion_model_name_or_path, subfolder="tokenizer", local_files_only=True)
    try:
