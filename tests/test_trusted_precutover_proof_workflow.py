...
COMPANION_BUILDER_COMMIT = "274a411472bbded27da55a0b33d8f5627c6ef0f7"
...
@pytest.mark.parametrize(
    ...
    (
        lambda source: source.replace(
            '--signer-digest "691b5056e8b9bf2667bc527b2170780b05863946"',
        ...
        lambda source: source.replace(
            '--signer-digest "691b5056e8b9bf2667bc527b2170780b05863946"',
            '; Write-Output --signer-digest "691b5056e8b9bf2667bc527b2170780b05863946"',
            1,
        ),
        lambda source: source.replace(
            '--signer-digest "691b5056e8b9bf2667bc527b2170780b05863946"',
...
def test_trusted_proof_policy_rejects_mutable_authority_and_execution_bypasses(tmp_path):
    ...
    mutations = {
        ...
        "untrusted-companion-source-binding": trusted.replace(
            f'--companion-source-commit "{COMPANION_BUILDER_COMMIT}"',
