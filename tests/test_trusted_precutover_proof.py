...
def build_inputs(root: Path) -> tuple[dict, dict]:
    ...
    evidence = {
        ...
        "builderWorkflowSha": "ccf38c95b3c33994d4c20039a506be062ebd2f99",
        "sourceCommit": source_commit,
...
def proof_for(identity: dict) -> dict:
    ...
    return {
        ...
        "companion": {
            ...
            "sourceCommit": "3abc93b61b5eaa7d4302117f593641dccf1d969c",
        },
...
def test_execute_binds_verified_companion_and_builder_evidence_into_signed_proof(tmp_path):
    ...
    actual = bind_execution_proof(
        ...
        companion_source_commit="3abc93b61b5eaa7d4302117f593641dccf1d969c",
        output=proof_path,
    )
